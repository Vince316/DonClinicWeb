  ...
  return (
    <aside className="w-64 bg-white min-h-screen fixed left-0 top-0 border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200 relative" ref={dropRef}>
        ...
        >
          <div className="w-9 h-9 bg-gradient-to-br from-sky-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
            {user?.name?.[0] || 'P'}
          </div>
